...
const Customers = () => {
  ...
  const notifySuccess = () => toast.success("✔️ Customer Created!");
  const notifyProjectSuccess = () => toast.success("✔️ Project Created!");
  const notifyWarning = () => toast.warning("🗑️ Customer Deleted!");
